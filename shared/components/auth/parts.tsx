...
export function GoogleButton({
  ...
  return (
    <button
      ...
      className="flex w-full items-center justify-center gap-2 rounded-full border border-border bg-background py-3 text-sm font-medium text-foreground-heading transition hover:bg-surface-card disabled:opacity-60"
    >
      <GoogleGlyph />
...
export function WhatsAppButton() {
  ...
  return (
    <button
      ...
      className="flex w-full items-center justify-center gap-2 rounded-full border border-border bg-background py-3 text-sm font-medium text-foreground-heading transition hover:bg-surface-card disabled:cursor-not-allowed disabled:opacity-60"
    >
