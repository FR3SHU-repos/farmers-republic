...
// remove strict import of the full Farmer type if present
    ...
    <Link href={`/farmers/${farmer.id}`} className="block">
      ...
      >
        <div className="w-20 h-20 relative rounded-lg overflow-hidden flex-shrink-0 bg-stone-100">
          {farmer.avatar ? (
            // next/image requires remotePatterns configured in next.config.js for external images
            // you can keep Image here; if you get a runtime error, switch to <img />
